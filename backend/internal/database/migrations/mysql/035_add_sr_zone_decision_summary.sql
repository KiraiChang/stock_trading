...
ALTER TABLE stock_sr_zone_analyses ADD COLUMN decision_summary TEXT NULL;
UPDATE stock_sr_zone_analyses SET decision_summary = 'null' WHERE decision_summary IS NULL;
