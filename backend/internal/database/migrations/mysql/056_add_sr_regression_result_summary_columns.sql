...
CREATE INDEX idx_stock_sr_regression_results_schema ON stock_sr_regression_results(schema_version, created_at);
CREATE INDEX idx_stock_sr_regression_results_governance ON stock_sr_regression_results(governance_health_state, created_at);

-- +goose Down
DROP INDEX idx_stock_sr_regression_results_governance ON stock_sr_regression_results;
DROP INDEX idx_stock_sr_regression_results_schema ON stock_sr_regression_results;
