...
ALTER TABLE corporate_actions
    ADD COLUMN volume_factor DECIMAL(18,10) NOT NULL DEFAULT 1;
ALTER TABLE candles
    ADD COLUMN vol_factor DECIMAL(18,10) NOT NULL DEFAULT 1;
...
-- +goose Down
ALTER TABLE corporate_actions DROP CONSTRAINT ck_corporate_actions_volume_factor;
