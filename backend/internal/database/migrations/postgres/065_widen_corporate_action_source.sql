...
-- +goose Up
ALTER TABLE corporate_actions ALTER COLUMN source TYPE VARCHAR(255);

-- +goose Down
DELETE FROM corporate_actions WHERE LENGTH(source) > 32;
ALTER TABLE corporate_actions ALTER COLUMN source TYPE VARCHAR(32);
